...
interface JQueryStatic {
     ...
     * @param func The function to process each items against. The first argument to the function is the items, and the second argument is the index. The function should return a Boolean value.  this will be the global window object.
     ...
     * @param callback The function to process each items against. The first argument to the function is the array items, the second argument is the index in array The function can return any value. Within the function, this refers to the global (window) object.
     */
     ...
     * @param callback The function to process each items against. The first argument to the function is the value; the second argument is the index or key of the array or object property. The function can return any value to add to the array. A returned array will be flattened into the resulting array. Within the function, this refers to the global (window) object.
     */
...
interface JQuery {
     ...
     *
     * @param duration An integer indicating the number of milliseconds to delay execution of the next items in the queue.
     * @param queueName A string containing the name of the queue. Defaults to fx, the standard effects queue.
     */
